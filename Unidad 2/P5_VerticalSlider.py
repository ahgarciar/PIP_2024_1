...
class MyApp(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.vs_mascotas.setMinimum(1)
        self.vs_mascotas.setMaximum(5)
        self.vs_mascotas.setSingleStep(1)
        self.vs_mascotas.setValue(1)
        self.vs_mascotas.valueChanged.connect(self.cambia)

    def cambia(self):
        dataClave = self.vs_mascotas.value()
        print(dataClave)
